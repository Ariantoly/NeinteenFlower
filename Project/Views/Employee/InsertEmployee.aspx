<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsertEmployee.aspx.cs" Inherits="Project.Views.InsertEmployee" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="salaryTxt" TextMode="Number" runat="server"></asp:TextBox>
        <br />
